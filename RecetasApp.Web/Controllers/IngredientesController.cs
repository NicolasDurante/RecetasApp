...
namespace RecetasApp.Web.Controllers
{
    public class IngredientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ingredient")] Ingrediente ingrediente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ingredient")] Ingrediente ingrediente)
        {
